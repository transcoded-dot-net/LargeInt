...
_GLIBCXX_BEGIN_NAMESPACE_LDBL
  ...
  template<typename _CharT, typename _InIter>
      ...
      while (!__testeof)
	{
      ...
      // Only need acceptable number for floating point numbers.
  ...
  template<typename _CharT, typename _InIter>
	...
	// Next, look for leading zeros and check required number
	// for base formats.
	...
	if (__lc->_M_use_grouping)
	  {
	    ...
	    // of number + space is reserved for numeric base or sign.
