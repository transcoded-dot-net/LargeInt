  ...
  template<typename _CharT>
    ...
    public:
      ...
      */
       ...
       *  of number in a group.  The first char in the string
       *  represents the number of number in the least significant
       *  group.  If a char is negative, it indicates an unlimited
       *  number of number for the group.  If more chars from the
       ...
       *  put more than 50 number into the least significant group if
